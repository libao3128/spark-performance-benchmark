...
GlobalLimit 100
+- LocalLimit 100
   +- Project [i_item_id#140, i_item_desc#143, s_store_id#111, s_store_name#115, store_sales_quantity#0L, store_returns_quantity#1L, catalog_sales_quantity#2L]
      +- Sort [i_item_id#140 ASC NULLS FIRST, i_item_desc#143 ASC NULLS FIRST, s_store_id#111 ASC NULLS FIRST, s_store_name#115 ASC NULLS FIRST], true
         +- Aggregate [i_item_id#140, i_item_desc#143, s_store_id#111, s_store_name#115], [i_item_id#140, i_item_desc#143, s_store_id#111, s_store_name#115, sum(cast(ss_quantity#15 as bigint)) AS store_sales_quantity#0L, sum(cast(sr_return_quantity#38 as bigint)) AS store_returns_quantity#1L, sum(cast(cs_quantity#66 as bigint)) AS catalog_sales_quantity#2L]
            +- Filter (((((d_moy#90 = 9) && (d_year#88 = 1999)) && ((d_date_sk#82 = ss_sold_date_sk#5) && (i_item_sk#139 = ss_item_sk#7))) && (((s_store_sk#110 = ss_store_sk#12) && (ss_customer_sk#8 = sr_customer_sk#31)) && ((ss_item_sk#7 = sr_item_sk#30) && (ss_ticket_number#14 = sr_ticket_number#37)))) && ((((sr_returned_date_sk#28 = d_date_sk#161) && ((d_moy#169 >= 9) && (d_moy#169 <= (9 + 3)))) && ((d_year#167 = 1999) && (sr_customer_sk#31 = cs_bill_customer_sk#51))) && (((sr_item_sk#30 = cs_item_sk#63) && (cs_sold_date_sk#48 = d_date_sk#189)) && d_year#195 IN (1999,(1999 + 1),(1999 + 2)))))
               +- Join Inner
                  :- Join Inner
                  :  :- Join Inner
                  :  :  :- Join Inner
...
+- LocalLimit 100
   +- Sort [i_item_id#140 ASC NULLS FIRST, i_item_desc#143 ASC NULLS FIRST, s_store_id#111 ASC NULLS FIRST, s_store_name#115 ASC NULLS FIRST], true
      +- Aggregate [i_item_id#140, i_item_desc#143, s_store_id#111, s_store_name#115], [i_item_id#140, i_item_desc#143, s_store_id#111, s_store_name#115, sum(cast(ss_quantity#15 as bigint)) AS store_sales_quantity#0L, sum(cast(sr_return_quantity#38 as bigint)) AS store_returns_quantity#1L, sum(cast(cs_quantity#66 as bigint)) AS catalog_sales_quantity#2L]
         +- Project [ss_quantity#15, sr_return_quantity#38, cs_quantity#66, s_store_id#111, s_store_name#115, i_item_id#140, i_item_desc#143]
            +- Join Inner, (i_item_sk#139 = ss_item_sk#7)
               :- Project [ss_item_sk#7, ss_quantity#15, sr_return_quantity#38, cs_quantity#66, s_store_id#111, s_store_name#115]
               :  +- Join Inner, (s_store_sk#110 = ss_store_sk#12)
               :     :- Project [ss_item_sk#7, ss_store_sk#12, ss_quantity#15, sr_return_quantity#38, cs_quantity#66]
               :     :  +- Join Inner, (cs_sold_date_sk#48 = d_date_sk#189)
               :     :     :- Project [ss_item_sk#7, ss_store_sk#12, ss_quantity#15, sr_return_quantity#38, cs_sold_date_sk#48, cs_quantity#66]
               :     :     :  +- Join Inner, (sr_returned_date_sk#28 = d_date_sk#161)
               :     :     :     :- Project [ss_item_sk#7, ss_store_sk#12, ss_quantity#15, sr_returned_date_sk#28, sr_return_quantity#38, cs_sold_date_sk#48, cs_quantity#66]
               :     :     :     :  +- Join Inner, (d_date_sk#82 = ss_sold_date_sk#5)
               :     :     :     :     :- Project [ss_sold_date_sk#5, ss_item_sk#7, ss_store_sk#12, ss_quantity#15, sr_returned_date_sk#28, sr_return_quantity#38, cs_sold_date_sk#48, cs_quantity#66]
               :     :     :     :     :  +- Join Inner, ((sr_customer_sk#31 = cs_bill_customer_sk#51) && (sr_item_sk#30 = cs_item_sk#63))
               :     :     :     :     :     :- Project [ss_sold_date_sk#5, ss_item_sk#7, ss_store_sk#12, ss_quantity#15, sr_returned_date_sk#28, sr_item_sk#30, sr_customer_sk#31, sr_return_quantity#38]
               :     :     :     :     :     :  +- Join Inner, (((ss_customer_sk#8 = sr_customer_sk#31) && (ss_item_sk#7 = sr_item_sk#30)) && (ss_ticket_number#14 = sr_ticket_number#37))
               :     :     :     :     :     :     :- Project [ss_sold_date_sk#5, ss_item_sk#7, ss_customer_sk#8, ss_store_sk#12, ss_ticket_number#14, ss_quantity#15]
               ...
               :     :     :     :     :     :     :     +- Relation[ss_sold_date_sk#5,ss_sold_time_sk#6,ss_item_sk#7,ss_customer_sk#8,ss_cdemo_sk#9,ss_hdemo_sk#10,ss_addr_sk#11,ss_store_sk#12,ss_promo_sk#13,ss_ticket_number#14,ss_quantity#15,ss_wholesale_cost#16,ss_list_price#17,ss_sales_price#18,ss_ext_discount_amt#19,ss_ext_sales_price#20,ss_ext_wholesale_cost#21,ss_ext_list_price#22,ss_ext_tax#23,ss_coupon_amt#24,ss_net_paid#25,ss_net_paid_inc_tax#26,ss_net_profit#27] parquet
               :     :     :     :     :     :     +- Project [sr_returned_date_sk#28, sr_item_sk#30, sr_customer_sk#31, sr_ticket_number#37, sr_return_quantity#38]
               ...
               :     :     :     :     :     :           +- Relation[sr_returned_date_sk#28,sr_return_time_sk#29,sr_item_sk#30,sr_customer_sk#31,sr_cdemo_sk#32,sr_hdemo_sk#33,sr_addr_sk#34,sr_store_sk#35,sr_reason_sk#36,sr_ticket_number#37,sr_return_quantity#38,sr_return_amt#39,sr_return_tax#40,sr_return_amt_inc_tax#41,sr_fee#42,sr_return_ship_cost#43,sr_refunded_cash#44,sr_reversed_charge#45,sr_store_credit#46,sr_net_loss#47] parquet
               :     :     :     :     :     +- Project [cs_sold_date_sk#48, cs_bill_customer_sk#51, cs_item_sk#63, cs_quantity#66]
               :     :     :     :     :        +- Filter ((isnotnull(cs_bill_customer_sk#51) && isnotnull(cs_item_sk#63)) && isnotnull(cs_sold_date_sk#48))
               :     :     :     :     :           +- Relation[cs_sold_date_sk#48,cs_sold_time_sk#49,cs_ship_date_sk#50,cs_bill_customer_sk#51,cs_bill_cdemo_sk#52,cs_bill_hdemo_sk#53,cs_bill_addr_sk#54,cs_ship_customer_sk#55,cs_ship_cdemo_sk#56,cs_ship_hdemo_sk#57,cs_ship_addr_sk#58,cs_call_center_sk#59,cs_catalog_page_sk#60,cs_ship_mode_sk#61,cs_warehouse_sk#62,cs_item_sk#63,cs_promo_sk#64,cs_order_number#65,cs_quantity#66,cs_wholesale_cost#67,cs_list_price#68,cs_sales_price#69,cs_ext_discount_amt#70,cs_ext_sales_price#71,... 10 more fields] parquet
               :     :     :     :     +- Project [d_date_sk#82]
               :     :     :     :        +- Filter ((((isnotnull(d_moy#90) && isnotnull(d_year#88)) && (d_moy#90 = 9)) && (d_year#88 = 1999)) && isnotnull(d_date_sk#82))
               :     :     :     :           +- Relation[d_date_sk#82,d_date_id#83,d_date#84,d_month_seq#85,d_week_seq#86,d_quarter_seq#87,d_year#88,d_dow#89,d_moy#90,d_dom#91,d_qoy#92,d_fy_year#93,d_fy_quarter_seq#94,d_fy_week_seq#95,d_day_name#96,d_quarter_name#97,d_holiday#98,d_weekend#99,d_following_holiday#100,d_first_dom#101,d_last_dom#102,d_same_day_ly#103,d_same_day_lq#104,d_current_day#105,... 4 more fields] parquet
               :     :     :     +- Project [d_date_sk#161]
               :     :     :        +- Filter (((((isnotnull(d_year#167) && isnotnull(d_moy#169)) && (d_moy#169 >= 9)) && (d_moy#169 <= 12)) && (d_year#167 = 1999)) && isnotnull(d_date_sk#161))
               :     :     :           +- Relation[d_date_sk#161,d_date_id#162,d_date#163,d_month_seq#164,d_week_seq#165,d_quarter_seq#166,d_year#167,d_dow#168,d_moy#169,d_dom#170,d_qoy#171,d_fy_year#172,d_fy_quarter_seq#173,d_fy_week_seq#174,d_day_name#175,d_quarter_name#176,d_holiday#177,d_weekend#178,d_following_holiday#179,d_first_dom#180,d_last_dom#181,d_same_day_ly#182,d_same_day_lq#183,d_current_day#184,... 4 more fields] parquet
               :     :     +- Project [d_date_sk#189]
               :     :        +- Filter (d_year#195 IN (1999,2000,2001) && isnotnull(d_date_sk#189))
               :     :           +- Relation[d_date_sk#189,d_date_id#190,d_date#191,d_month_seq#192,d_week_seq#193,d_quarter_seq#194,d_year#195,d_dow#196,d_moy#197,d_dom#198,d_qoy#199,d_fy_year#200,d_fy_quarter_seq#201,d_fy_week_seq#202,d_day_name#203,d_quarter_name#204,d_holiday#205,d_weekend#206,d_following_holiday#207,d_first_dom#208,d_last_dom#209,d_same_day_ly#210,d_same_day_lq#211,d_current_day#212,... 4 more fields] parquet
...
== Physical Plan ==
TakeOrderedAndProject(limit=100, orderBy=[i_item_id#140 ASC NULLS FIRST,i_item_desc#143 ASC NULLS FIRST,s_store_id#111 ASC NULLS FIRST,s_store_name#115 ASC NULLS FIRST], output=[i_item_id#140,i_item_desc#143,s_store_id#111,s_store_name#115,store_sales_quantity#0L,store_returns_quantity#1L,catalog_sales_quantity#2L])
+- *(12) HashAggregate(keys=[i_item_id#140, i_item_desc#143, s_store_id#111, s_store_name#115], functions=[sum(cast(ss_quantity#15 as bigint)), sum(cast(sr_return_quantity#38 as bigint)), sum(cast(cs_quantity#66 as bigint))], output=[i_item_id#140, i_item_desc#143, s_store_id#111, s_store_name#115, store_sales_quantity#0L, store_returns_quantity#1L, catalog_sales_quantity#2L])
   +- Exchange hashpartitioning(i_item_id#140, i_item_desc#143, s_store_id#111, s_store_name#115, 200)
      +- *(11) HashAggregate(keys=[i_item_id#140, i_item_desc#143, s_store_id#111, s_store_name#115], functions=[partial_sum(cast(ss_quantity#15 as bigint)), partial_sum(cast(sr_return_quantity#38 as bigint)), partial_sum(cast(cs_quantity#66 as bigint))], output=[i_item_id#140, i_item_desc#143, s_store_id#111, s_store_name#115, sum#227L, sum#228L, sum#229L])
         +- *(11) Project [ss_quantity#15, sr_return_quantity#38, cs_quantity#66, s_store_id#111, s_store_name#115, i_item_id#140, i_item_desc#143]
            +- *(11) BroadcastHashJoin [ss_item_sk#7], [i_item_sk#139], Inner, BuildRight
               :- *(11) Project [ss_item_sk#7, ss_quantity#15, sr_return_quantity#38, cs_quantity#66, s_store_id#111, s_store_name#115]
               :  +- *(11) BroadcastHashJoin [ss_store_sk#12], [s_store_sk#110], Inner, BuildRight
               :     :- *(11) Project [ss_item_sk#7, ss_store_sk#12, ss_quantity#15, sr_return_quantity#38, cs_quantity#66]
               :     :  +- *(11) BroadcastHashJoin [cs_sold_date_sk#48], [d_date_sk#189], Inner, BuildRight
               :     :     :- *(11) Project [ss_item_sk#7, ss_store_sk#12, ss_quantity#15, sr_return_quantity#38, cs_sold_date_sk#48, cs_quantity#66]
               :     :     :  +- *(11) BroadcastHashJoin [sr_returned_date_sk#28], [d_date_sk#161], Inner, BuildRight
               :     :     :     :- *(11) Project [ss_item_sk#7, ss_store_sk#12, ss_quantity#15, sr_returned_date_sk#28, sr_return_quantity#38, cs_sold_date_sk#48, cs_quantity#66]
               :     :     :     :  +- *(11) BroadcastHashJoin [ss_sold_date_sk#5], [d_date_sk#82], Inner, BuildRight
               :     :     :     :     :- *(11) Project [ss_sold_date_sk#5, ss_item_sk#7, ss_store_sk#12, ss_quantity#15, sr_returned_date_sk#28, sr_return_quantity#38, cs_sold_date_sk#48, cs_quantity#66]
               ...
               :     :     :     :     :     :     +- *(2) Project [ss_sold_date_sk#5, ss_item_sk#7, ss_store_sk#12, ss_quantity#15, sr_returned_date_sk#28, sr_item_sk#30, sr_customer_sk#31, sr_return_quantity#38]
               ...
               :     :     :     :     :     :           :- *(2) Project [ss_sold_date_sk#5, ss_item_sk#7, ss_customer_sk#8, ss_store_sk#12, ss_ticket_number#14, ss_quantity#15]
               ...
               :     :     :     :     :     :                    +- *(1) FileScan parquet tpcds.store_returns[sr_returned_date_sk#28,sr_item_sk#30,sr_customer_sk#31,sr_ticket_number#37,sr_return_quantity#38] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/s..., PartitionFilters: [], PushedFilters: [IsNotNull(sr_customer_sk), IsNotNull(sr_ticket_number), IsNotNull(sr_item_sk), IsNotNull(sr_retu..., ReadSchema: struct<sr_returned_date_sk:int,sr_item_sk:int,sr_customer_sk:int,sr_ticket_number:int,sr_return_q...
               ...
               :     :     :     :     :           +- *(4) Project [cs_sold_date_sk#48, cs_bill_customer_sk#51, cs_item_sk#63, cs_quantity#66]
               :     :     :     :     :              +- *(4) Filter ((isnotnull(cs_bill_customer_sk#51) && isnotnull(cs_item_sk#63)) && isnotnull(cs_sold_date_sk#48))
               :     :     :     :     :                 +- *(4) FileScan parquet tpcds.catalog_sales[cs_sold_date_sk#48,cs_bill_customer_sk#51,cs_item_sk#63,cs_quantity#66] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/c..., PartitionFilters: [], PushedFilters: [IsNotNull(cs_bill_customer_sk), IsNotNull(cs_item_sk), IsNotNull(cs_sold_date_sk)], ReadSchema: struct<cs_sold_date_sk:int,cs_bill_customer_sk:int,cs_item_sk:int,cs_quantity:int>
               :     :     :     :     +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
               :     :     :     :        +- *(6) Project [d_date_sk#82]
               :     :     :     :           +- *(6) Filter ((((isnotnull(d_moy#90) && isnotnull(d_year#88)) && (d_moy#90 = 9)) && (d_year#88 = 1999)) && isnotnull(d_date_sk#82))
               :     :     :     :              +- *(6) FileScan parquet tpcds.date_dim[d_date_sk#82,d_year#88,d_moy#90] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/d..., PartitionFilters: [], PushedFilters: [IsNotNull(d_moy), IsNotNull(d_year), EqualTo(d_moy,9), EqualTo(d_year,1999), IsNotNull(d_date_sk)], ReadSchema: struct<d_date_sk:int,d_year:int,d_moy:int>
               :     :     :     +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
               :     :     :        +- *(7) Project [d_date_sk#161]
               :     :     :           +- *(7) Filter (((((isnotnull(d_year#167) && isnotnull(d_moy#169)) && (d_moy#169 >= 9)) && (d_moy#169 <= 12)) && (d_year#167 = 1999)) && isnotnull(d_date_sk#161))
               :     :     :              +- *(7) FileScan parquet tpcds.date_dim[d_date_sk#161,d_year#167,d_moy#169] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/d..., PartitionFilters: [], PushedFilters: [IsNotNull(d_year), IsNotNull(d_moy), GreaterThanOrEqual(d_moy,9), LessThanOrEqual(d_moy,12), Equ..., ReadSchema: struct<d_date_sk:int,d_year:int,d_moy:int>
               :     :     +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
               :     :        +- *(8) Project [d_date_sk#189]
               :     :           +- *(8) Filter (d_year#195 IN (1999,2000,2001) && isnotnull(d_date_sk#189))
               :     :              +- *(8) FileScan parquet tpcds.date_dim[d_date_sk#189,d_year#195] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/d..., PartitionFilters: [], PushedFilters: [In(d_year, [1999,2000,2001]), IsNotNull(d_date_sk)], ReadSchema: struct<d_date_sk:int,d_year:int>
               :     +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
...
Time taken: 4.617 seconds, Fetched 1 row(s)
Error in query: 
