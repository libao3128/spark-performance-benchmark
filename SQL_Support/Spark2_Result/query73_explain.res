...
Sort [cnt#0L DESC NULLS LAST, c_last_name#98 ASC NULLS FIRST], true
+- Project [c_last_name#98, c_first_name#97, c_salutation#96, c_preferred_cust_flag#99, ss_ticket_number#13, cnt#0L]
   +- Filter ((ss_customer_sk#7 = c_customer_sk#89) && ((cnt#0L >= cast(1 as bigint)) && (cnt#0L <= cast(5 as bigint))))
      +- Join Inner
         :- SubqueryAlias `dj`
         :  +- Aggregate [ss_ticket_number#13, ss_customer_sk#7], [ss_ticket_number#13, ss_customer_sk#7, count(1) AS cnt#0L]
         :     +- Filter (((((ss_sold_date_sk#4 = d_date_sk#27) && (ss_store_sk#11 = s_store_sk#55)) && (ss_hdemo_sk#9 = hd_demo_sk#84)) && (((d_dom#36 >= 1) && (d_dom#36 <= 2)) && ((hd_buy_potential#86 = >10000) || (hd_buy_potential#86 = Unknown)))) && (((hd_vehicle_count#88 > 0) && (CASE WHEN (hd_vehicle_count#88 > 0) THEN (cast(hd_dep_count#87 as double) / cast(hd_vehicle_count#88 as double)) ELSE cast(null as double) END > cast(1 as double))) && (d_year#33 IN (1999,(1999 + 1),(1999 + 2)) && s_county#78 IN (Williamson County,Franklin Parish,Bronx County,Orange County))))
         :        +- Join Inner
         :           :- Join Inner
         :           :  :- Join Inner
...
+- Project [c_last_name#98, c_first_name#97, c_salutation#96, c_preferred_cust_flag#99, ss_ticket_number#13, cnt#0L]
   +- Join Inner, (ss_customer_sk#7 = c_customer_sk#89)
      ...
      :           :     :        +- Filter ((((isnotnull(d_dom#36) && (d_dom#36 >= 1)) && (d_dom#36 <= 2)) && d_year#33 IN (1999,2000,2001)) && isnotnull(d_date_sk#27))
      :           :     :           +- Relation[d_date_sk#27,d_date_id#28,d_date#29,d_month_seq#30,d_week_seq#31,d_quarter_seq#32,d_year#33,d_dow#34,d_moy#35,d_dom#36,d_qoy#37,d_fy_year#38,d_fy_quarter_seq#39,d_fy_week_seq#40,d_day_name#41,d_quarter_name#42,d_holiday#43,d_weekend#44,d_following_holiday#45,d_first_dom#46,d_last_dom#47,d_same_day_ly#48,d_same_day_lq#49,d_current_day#50,... 4 more fields] parquet
      :           :     +- Project [s_store_sk#55]
      :           :        +- Filter (s_county#78 IN (Williamson County,Franklin Parish,Bronx County,Orange County) && isnotnull(s_store_sk#55))
      :           :           +- Relation[s_store_sk#55,s_store_id#56,s_rec_start_date#57,s_rec_end_date#58,s_closed_date_sk#59,s_store_name#60,s_number_employees#61,s_floor_space#62,s_hours#63,s_manager#64,s_market_id#65,s_geography_class#66,s_market_desc#67,s_market_manager#68,s_division_id#69,s_division_name#70,s_company_id#71,s_company_name#72,s_street_number#73,s_street_name#74,s_street_type#75,s_suite_number#76,s_city#77,s_county#78,... 5 more fields] parquet
      :           +- Project [hd_demo_sk#84]
      :              +- Filter ((((isnotnull(hd_vehicle_count#88) && ((hd_buy_potential#86 = >10000) || (hd_buy_potential#86 = Unknown))) && (hd_vehicle_count#88 > 0)) && (CASE WHEN (hd_vehicle_count#88 > 0) THEN (cast(hd_dep_count#87 as double) / cast(hd_vehicle_count#88 as double)) ELSE null END > 1.0)) && isnotnull(hd_demo_sk#84))
      :                 +- Relation[hd_demo_sk#84,hd_income_band_sk#85,hd_buy_potential#86,hd_dep_count#87,hd_vehicle_count#88] parquet
...
== Physical Plan ==
*(7) Sort [cnt#0L DESC NULLS LAST, c_last_name#98 ASC NULLS FIRST], true, 0
+- Exchange rangepartitioning(cnt#0L DESC NULLS LAST, c_last_name#98 ASC NULLS FIRST, 200)
   +- *(6) Project [c_last_name#98, c_first_name#97, c_salutation#96, c_preferred_cust_flag#99, ss_ticket_number#13, cnt#0L]
      +- *(6) BroadcastHashJoin [ss_customer_sk#7], [c_customer_sk#89], Inner, BuildRight
         ...
         :                 :     :           +- *(1) Filter ((((isnotnull(d_dom#36) && (d_dom#36 >= 1)) && (d_dom#36 <= 2)) && d_year#33 IN (1999,2000,2001)) && isnotnull(d_date_sk#27))
         :                 :     :              +- *(1) FileScan parquet tpcds.date_dim[d_date_sk#27,d_year#33,d_dom#36] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/d..., PartitionFilters: [], PushedFilters: [IsNotNull(d_dom), GreaterThanOrEqual(d_dom,1), LessThanOrEqual(d_dom,2), In(d_year, [1999,2000,2..., ReadSchema: struct<d_date_sk:int,d_year:int,d_dom:int>
         :                 :     +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
         :                 :        +- *(2) Project [s_store_sk#55]
         :                 :           +- *(2) Filter (s_county#78 IN (Williamson County,Franklin Parish,Bronx County,Orange County) && isnotnull(s_store_sk#55))
         :                 :              +- *(2) FileScan parquet tpcds.store[s_store_sk#55,s_county#78] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/s..., PartitionFilters: [], PushedFilters: [In(s_county, [Williamson County,Franklin Parish,Bronx County,Orange County]), IsNotNull(s_store_..., ReadSchema: struct<s_store_sk:int,s_county:string>
         :                 +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
         :                    +- *(3) Project [hd_demo_sk#84]
         :                       +- *(3) Filter ((((isnotnull(hd_vehicle_count#88) && ((hd_buy_potential#86 = >10000) || (hd_buy_potential#86 = Unknown))) && (hd_vehicle_count#88 > 0)) && (CASE WHEN (hd_vehicle_count#88 > 0) THEN (cast(hd_dep_count#87 as double) / cast(hd_vehicle_count#88 as double)) ELSE null END > 1.0)) && isnotnull(hd_demo_sk#84))
...
Time taken: 4.34 seconds, Fetched 1 row(s)
Error in query: 
