...
:  :     +- 'Filter ((('i_item_id IN (list#2 []) && ('ss_item_sk = 'i_item_sk)) && (('ss_sold_date_sk = 'd_date_sk) && ('d_year = 1998))) && ((('d_moy = 9) && ('ss_addr_sk = 'ca_address_sk)) && ('ca_gmt_offset = -5)))
:  :        :  +- 'Project ['i_item_id]
...
:  :     +- 'Filter ((('i_item_id IN (list#4 []) && ('cs_item_sk = 'i_item_sk)) && (('cs_sold_date_sk = 'd_date_sk) && ('d_year = 1998))) && ((('d_moy = 9) && ('cs_bill_addr_sk = 'ca_address_sk)) && ('ca_gmt_offset = -5)))
:  :        :  +- 'Project ['i_item_id]
:  :        :     +- 'Filter 'i_category IN (Music)
:  :        :        +- 'UnresolvedRelation `item`
:  :        +- 'Join Inner
...
:        +- 'Filter ((('i_item_id IN (list#6 []) && ('ws_item_sk = 'i_item_sk)) && (('ws_sold_date_sk = 'd_date_sk) && ('d_year = 1998))) && ((('d_moy = 9) && ('ws_bill_addr_sk = 'ca_address_sk)) && ('ca_gmt_offset = -5)))
:           :  +- 'Project ['i_item_id]
:           :     +- 'Filter 'i_category IN (Music)
:           :        +- 'UnresolvedRelation `item`
:           +- 'Join Inner
...
GlobalLimit 100
+- LocalLimit 100
   +- Sort [i_item_id#74 ASC NULLS FIRST, total_sales#0 ASC NULLS FIRST], true
      +- Aggregate [i_item_id#74], [i_item_id#74, sum(total_sales#1) AS total_sales#0]
         +- SubqueryAlias `tmp1`
            +- Union
               :- Union
               :  :- Project [i_item_id#74, total_sales#1]
               :  :  +- SubqueryAlias `ss`
               :  :     +- Aggregate [i_item_id#74], [i_item_id#74, sum(ss_ext_sales_price#24) AS total_sales#1]
               :  :        +- Filter (((i_item_id#74 IN (list#2 []) && (ss_item_sk#11 = i_item_sk#73)) && ((ss_sold_date_sk#9 = d_date_sk#32) && (d_year#38 = 1998))) && (((d_moy#40 = 9) && (ss_addr_sk#15 = ca_address_sk#60)) && (ca_gmt_offset#71 = cast(-5 as double))))
               :  :           :  +- Project [i_item_id#74]
               :  :           :     +- Filter i_category#85 IN (Music)
               ...
               :  :              +- SubqueryAlias `tpcds`.`item`
               :  :                 +- Relation[i_item_sk#73,i_item_id#74,i_rec_start_date#75,i_rec_end_date#76,i_item_desc#77,i_current_price#78,i_wholesale_cost#79,i_brand_id#80,i_brand#81,i_class_id#82,i_class#83,i_category_id#84,i_category#85,i_manufact_id#86,i_manufact#87,i_size#88,i_formulation#89,i_color#90,i_units#91,i_container#92,i_manager_id#93,i_product_name#94] parquet
               :  +- Project [i_item_id#74, total_sales#3]
               :     +- SubqueryAlias `cs`
               :        +- Aggregate [i_item_id#74], [i_item_id#74, sum(cs_ext_sales_price#119) AS total_sales#3]
               :           +- Filter (((i_item_id#74 IN (list#4 []) && (cs_item_sk#111 = i_item_sk#73)) && ((cs_sold_date_sk#96 = d_date_sk#32) && (d_year#38 = 1998))) && (((d_moy#40 = 9) && (cs_bill_addr_sk#102 = ca_address_sk#60)) && (ca_gmt_offset#71 = cast(-5 as double))))
               :              :  +- Project [i_item_id#74]
               :              :     +- Filter i_category#85 IN (Music)
               :              :        +- SubqueryAlias `tpcds`.`item`
               :              :           +- Relation[i_item_sk#73,i_item_id#74,i_rec_start_date#75,i_rec_end_date#76,i_item_desc#77,i_current_price#78,i_wholesale_cost#79,i_brand_id#80,i_brand#81,i_class_id#82,i_class#83,i_category_id#84,i_category#85,i_manufact_id#86,i_manufact#87,i_size#88,i_formulation#89,i_color#90,i_units#91,i_container#92,i_manager_id#93,i_product_name#94] parquet
               ...
               :                 +- SubqueryAlias `tpcds`.`item`
               :                    +- Relation[i_item_sk#73,i_item_id#74,i_rec_start_date#75,i_rec_end_date#76,i_item_desc#77,i_current_price#78,i_wholesale_cost#79,i_brand_id#80,i_brand#81,i_class_id#82,i_class#83,i_category_id#84,i_category#85,i_manufact_id#86,i_manufact#87,i_size#88,i_formulation#89,i_color#90,i_units#91,i_container#92,i_manager_id#93,i_product_name#94] parquet
               +- Project [i_item_id#74, total_sales#5]
                  +- SubqueryAlias `ws`
                     +- Aggregate [i_item_id#74], [i_item_id#74, sum(ws_ext_sales_price#154) AS total_sales#5]
                        +- Filter (((i_item_id#74 IN (list#6 []) && (ws_item_sk#134 = i_item_sk#73)) && ((ws_sold_date_sk#131 = d_date_sk#32) && (d_year#38 = 1998))) && (((d_moy#40 = 9) && (ws_bill_addr_sk#138 = ca_address_sk#60)) && (ca_gmt_offset#71 = cast(-5 as double))))
                           :  +- Project [i_item_id#74]
                           :     +- Filter i_category#85 IN (Music)
                           :        +- SubqueryAlias `tpcds`.`item`
                           :           +- Relation[i_item_sk#73,i_item_id#74,i_rec_start_date#75,i_rec_end_date#76,i_item_desc#77,i_current_price#78,i_wholesale_cost#79,i_brand_id#80,i_brand#81,i_class_id#82,i_class#83,i_category_id#84,i_category#85,i_manufact_id#86,i_manufact#87,i_size#88,i_formulation#89,i_color#90,i_units#91,i_container#92,i_manager_id#93,i_product_name#94] parquet
...
+- LocalLimit 100
   +- Sort [i_item_id#74 ASC NULLS FIRST, total_sales#0 ASC NULLS FIRST], true
      +- Aggregate [i_item_id#74], [i_item_id#74, sum(total_sales#1) AS total_sales#0]
         +- Union
            :- Aggregate [i_item_id#74], [i_item_id#74, sum(ss_ext_sales_price#24) AS total_sales#1]
            :  +- Project [ss_ext_sales_price#24, i_item_id#74]
            ...
            :        :     :        +- Filter ((((isnotnull(d_year#38) && isnotnull(d_moy#40)) && (d_year#38 = 1998)) && (d_moy#40 = 9)) && isnotnull(d_date_sk#32))
            :        :     :           +- Relation[d_date_sk#32,d_date_id#33,d_date#34,d_month_seq#35,d_week_seq#36,d_quarter_seq#37,d_year#38,d_dow#39,d_moy#40,d_dom#41,d_qoy#42,d_fy_year#43,d_fy_quarter_seq#44,d_fy_week_seq#45,d_day_name#46,d_quarter_name#47,d_holiday#48,d_weekend#49,d_following_holiday#50,d_first_dom#51,d_last_dom#52,d_same_day_ly#53,d_same_day_lq#54,d_current_day#55,... 4 more fields] parquet
            :        :     +- Project [ca_address_sk#60]
            :        :        +- Filter ((isnotnull(ca_gmt_offset#71) && (ca_gmt_offset#71 = -5.0)) && isnotnull(ca_address_sk#60))
            :        :           +- Relation[ca_address_sk#60,ca_address_id#61,ca_street_number#62,ca_street_name#63,ca_street_type#64,ca_suite_number#65,ca_city#66,ca_county#67,ca_state#68,ca_zip#69,ca_country#70,ca_gmt_offset#71,ca_location_type#72] parquet
            :        +- Join LeftSemi, (i_item_id#74 = i_item_id#74#169)
            :           :- Project [i_item_sk#73, i_item_id#74]
            :           :  +- Filter isnotnull(i_item_sk#73)
            :           :     +- Relation[i_item_sk#73,i_item_id#74,i_rec_start_date#75,i_rec_end_date#76,i_item_desc#77,i_current_price#78,i_wholesale_cost#79,i_brand_id#80,i_brand#81,i_class_id#82,i_class#83,i_category_id#84,i_category#85,i_manufact_id#86,i_manufact#87,i_size#88,i_formulation#89,i_color#90,i_units#91,i_container#92,i_manager_id#93,i_product_name#94] parquet
            :           +- Project [i_item_id#74 AS i_item_id#74#169]
            :              +- Filter (isnotnull(i_category#85) && (i_category#85 = Music))
            :                 +- Relation[i_item_sk#73,i_item_id#74,i_rec_start_date#75,i_rec_end_date#76,i_item_desc#77,i_current_price#78,i_wholesale_cost#79,i_brand_id#80,i_brand#81,i_class_id#82,i_class#83,i_category_id#84,i_category#85,i_manufact_id#86,i_manufact#87,i_size#88,i_formulation#89,i_color#90,i_units#91,i_container#92,i_manager_id#93,i_product_name#94] parquet
            :- Aggregate [i_item_id#74], [i_item_id#74, sum(cs_ext_sales_price#119) AS total_sales#3]
            :  +- Project [cs_ext_sales_price#119, i_item_id#74]
            ...
            :        :        +- Filter ((isnotnull(ca_gmt_offset#71) && (ca_gmt_offset#71 = -5.0)) && isnotnull(ca_address_sk#60))
            :        :           +- Relation[ca_address_sk#60,ca_address_id#61,ca_street_number#62,ca_street_name#63,ca_street_type#64,ca_suite_number#65,ca_city#66,ca_county#67,ca_state#68,ca_zip#69,ca_country#70,ca_gmt_offset#71,ca_location_type#72] parquet
            :        +- Join LeftSemi, (i_item_id#74 = i_item_id#74#170)
            :           :- Project [i_item_sk#73, i_item_id#74]
            :           :  +- Filter isnotnull(i_item_sk#73)
            :           :     +- Relation[i_item_sk#73,i_item_id#74,i_rec_start_date#75,i_rec_end_date#76,i_item_desc#77,i_current_price#78,i_wholesale_cost#79,i_brand_id#80,i_brand#81,i_class_id#82,i_class#83,i_category_id#84,i_category#85,i_manufact_id#86,i_manufact#87,i_size#88,i_formulation#89,i_color#90,i_units#91,i_container#92,i_manager_id#93,i_product_name#94] parquet
            :           +- Project [i_item_id#74 AS i_item_id#74#170]
            :              +- Filter (isnotnull(i_category#85) && (i_category#85 = Music))
            :                 +- Relation[i_item_sk#73,i_item_id#74,i_rec_start_date#75,i_rec_end_date#76,i_item_desc#77,i_current_price#78,i_wholesale_cost#79,i_brand_id#80,i_brand#81,i_class_id#82,i_class#83,i_category_id#84,i_category#85,i_manufact_id#86,i_manufact#87,i_size#88,i_formulation#89,i_color#90,i_units#91,i_container#92,i_manager_id#93,i_product_name#94] parquet
            +- Aggregate [i_item_id#74], [i_item_id#74, sum(ws_ext_sales_price#154) AS total_sales#5]
               +- Project [ws_ext_sales_price#154, i_item_id#74]
                  +- Join Inner, (ws_item_sk#134 = i_item_sk#73)
                     ...
                     :        +- Filter ((isnotnull(ca_gmt_offset#71) && (ca_gmt_offset#71 = -5.0)) && isnotnull(ca_address_sk#60))
                     :           +- Relation[ca_address_sk#60,ca_address_id#61,ca_street_number#62,ca_street_name#63,ca_street_type#64,ca_suite_number#65,ca_city#66,ca_county#67,ca_state#68,ca_zip#69,ca_country#70,ca_gmt_offset#71,ca_location_type#72] parquet
                     +- Join LeftSemi, (i_item_id#74 = i_item_id#74#171)
                        :- Project [i_item_sk#73, i_item_id#74]
                        :  +- Filter isnotnull(i_item_sk#73)
                        :     +- Relation[i_item_sk#73,i_item_id#74,i_rec_start_date#75,i_rec_end_date#76,i_item_desc#77,i_current_price#78,i_wholesale_cost#79,i_brand_id#80,i_brand#81,i_class_id#82,i_class#83,i_category_id#84,i_category#85,i_manufact_id#86,i_manufact#87,i_size#88,i_formulation#89,i_color#90,i_units#91,i_container#92,i_manager_id#93,i_product_name#94] parquet
                        +- Project [i_item_id#74 AS i_item_id#74#171]
                           +- Filter (isnotnull(i_category#85) && (i_category#85 = Music))
                              +- Relation[i_item_sk#73,i_item_id#74,i_rec_start_date#75,i_rec_end_date#76,i_item_desc#77,i_current_price#78,i_wholesale_cost#79,i_brand_id#80,i_brand#81,i_class_id#82,i_class#83,i_category_id#84,i_category#85,i_manufact_id#86,i_manufact#87,i_size#88,i_formulation#89,i_color#90,i_units#91,i_container#92,i_manager_id#93,i_product_name#94] parquet

== Physical Plan ==
TakeOrderedAndProject(limit=100, orderBy=[i_item_id#74 ASC NULLS FIRST,total_sales#0 ASC NULLS FIRST], output=[i_item_id#74,total_sales#0])
+- *(20) HashAggregate(keys=[i_item_id#74], functions=[sum(total_sales#1)], output=[i_item_id#74, total_sales#0])
   +- Exchange hashpartitioning(i_item_id#74, 200)
      +- *(19) HashAggregate(keys=[i_item_id#74], functions=[partial_sum(total_sales#1)], output=[i_item_id#74, sum#173])
         +- Union
            :- *(6) HashAggregate(keys=[i_item_id#74], functions=[sum(ss_ext_sales_price#24)], output=[i_item_id#74, total_sales#1])
            :  +- Exchange hashpartitioning(i_item_id#74, 200)
            :     +- *(5) HashAggregate(keys=[i_item_id#74], functions=[partial_sum(ss_ext_sales_price#24)], output=[i_item_id#74, sum#175])
            :        +- *(5) Project [ss_ext_sales_price#24, i_item_id#74]
            ...
            :              :     :           +- *(1) Filter ((((isnotnull(d_year#38) && isnotnull(d_moy#40)) && (d_year#38 = 1998)) && (d_moy#40 = 9)) && isnotnull(d_date_sk#32))
            :              :     :              +- *(1) FileScan parquet tpcds.date_dim[d_date_sk#32,d_year#38,d_moy#40] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/d..., PartitionFilters: [], PushedFilters: [IsNotNull(d_year), IsNotNull(d_moy), EqualTo(d_year,1998), EqualTo(d_moy,9), IsNotNull(d_date_sk)], ReadSchema: struct<d_date_sk:int,d_year:int,d_moy:int>
            :              :     +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
            ...
            :              +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
            :                 +- *(4) BroadcastHashJoin [i_item_id#74], [i_item_id#74#169], LeftSemi, BuildRight
            :                    :- *(4) Project [i_item_sk#73, i_item_id#74]
            :                    :  +- *(4) Filter isnotnull(i_item_sk#73)
            :                    :     +- *(4) FileScan parquet tpcds.item[i_item_sk#73,i_item_id#74] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/i..., PartitionFilters: [], PushedFilters: [IsNotNull(i_item_sk)], ReadSchema: struct<i_item_sk:int,i_item_id:string>
            :                    +- BroadcastExchange HashedRelationBroadcastMode(List(input[0, string, true]))
            :                       +- *(3) Project [i_item_id#74 AS i_item_id#74#169]
            :                          +- *(3) Filter (isnotnull(i_category#85) && (i_category#85 = Music))
            :                             +- *(3) FileScan parquet tpcds.item[i_item_id#74,i_category#85] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/i..., PartitionFilters: [], PushedFilters: [IsNotNull(i_category), EqualTo(i_category,Music)], ReadSchema: struct<i_item_id:string,i_category:string>
            :- *(12) HashAggregate(keys=[i_item_id#74], functions=[sum(cs_ext_sales_price#119)], output=[i_item_id#74, total_sales#3])
            :  +- Exchange hashpartitioning(i_item_id#74, 200)
            :     +- *(11) HashAggregate(keys=[i_item_id#74], functions=[partial_sum(cs_ext_sales_price#119)], output=[i_item_id#74, sum#177])
            :        +- *(11) Project [cs_ext_sales_price#119, i_item_id#74]
            ...
            :              +- ReusedExchange [i_item_sk#73, i_item_id#74], BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
            +- *(18) HashAggregate(keys=[i_item_id#74], functions=[sum(ws_ext_sales_price#154)], output=[i_item_id#74, total_sales#5])
               +- Exchange hashpartitioning(i_item_id#74, 200)
                  +- *(17) HashAggregate(keys=[i_item_id#74], functions=[partial_sum(ws_ext_sales_price#154)], output=[i_item_id#74, sum#179])
                     +- *(17) Project [ws_ext_sales_price#154, i_item_id#74]
                        +- *(17) BroadcastHashJoin [ws_item_sk#134], [i_item_sk#73], Inner, BuildRight
                           ...
                           :     +- ReusedExchange [ca_address_sk#60], BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
                           +- ReusedExchange [i_item_sk#73, i_item_id#74], BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
Time taken: 5.069 seconds, Fetched 1 row(s)
Error in query: 
