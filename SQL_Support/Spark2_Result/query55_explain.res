...
GlobalLimit 100
+- LocalLimit 100
   +- Project [brand_id#0, brand#1, ext_price#2]
      +- Sort [ext_price#2 DESC NULLS LAST, brand_id#0 ASC NULLS FIRST], true
         +- Aggregate [i_brand#64, i_brand_id#63], [i_brand_id#63 AS brand_id#0, i_brand#64 AS brand#1, sum(ss_ext_sales_price#48) AS ext_price#2]
            +- Filter ((((d_date_sk#5 = ss_sold_date_sk#33) && (ss_item_sk#35 = i_item_sk#56)) && (i_manager_id#76 = 28)) && ((d_moy#13 = 11) && (d_year#11 = 1999)))
               +- Join Inner
                  :- Join Inner
...
+- LocalLimit 100
   +- Sort [ext_price#2 DESC NULLS LAST, brand_id#0 ASC NULLS FIRST], true
      +- Aggregate [i_brand#64, i_brand_id#63], [i_brand_id#63 AS brand_id#0, i_brand#64 AS brand#1, sum(ss_ext_sales_price#48) AS ext_price#2]
         +- Project [ss_ext_sales_price#48, i_brand_id#63, i_brand#64]
            +- Join Inner, (ss_item_sk#35 = i_item_sk#56)
               :- Project [ss_item_sk#35, ss_ext_sales_price#48]
               :  +- Join Inner, (d_date_sk#5 = ss_sold_date_sk#33)
               :     :- Project [d_date_sk#5]
               :     :  +- Filter ((((isnotnull(d_moy#13) && isnotnull(d_year#11)) && (d_moy#13 = 11)) && (d_year#11 = 1999)) && isnotnull(d_date_sk#5))
               :     :     +- Relation[d_date_sk#5,d_date_id#6,d_date#7,d_month_seq#8,d_week_seq#9,d_quarter_seq#10,d_year#11,d_dow#12,d_moy#13,d_dom#14,d_qoy#15,d_fy_year#16,d_fy_quarter_seq#17,d_fy_week_seq#18,d_day_name#19,d_quarter_name#20,d_holiday#21,d_weekend#22,d_following_holiday#23,d_first_dom#24,d_last_dom#25,d_same_day_ly#26,d_same_day_lq#27,d_current_day#28,... 4 more fields] parquet
               ...
               +- Project [i_item_sk#56, i_brand_id#63, i_brand#64]
                  +- Filter ((isnotnull(i_manager_id#76) && (i_manager_id#76 = 28)) && isnotnull(i_item_sk#56))
                     +- Relation[i_item_sk#56,i_item_id#57,i_rec_start_date#58,i_rec_end_date#59,i_item_desc#60,i_current_price#61,i_wholesale_cost#62,i_brand_id#63,i_brand#64,i_class_id#65,i_class#66,i_category_id#67,i_category#68,i_manufact_id#69,i_manufact#70,i_size#71,i_formulation#72,i_color#73,i_units#74,i_container#75,i_manager_id#76,i_product_name#77] parquet
...
+- *(4) HashAggregate(keys=[i_brand#64, i_brand_id#63], functions=[sum(ss_ext_sales_price#48)], output=[brand_id#0, brand#1, ext_price#2])
   +- Exchange hashpartitioning(i_brand#64, i_brand_id#63, 200)
      +- *(3) HashAggregate(keys=[i_brand#64, i_brand_id#63], functions=[partial_sum(ss_ext_sales_price#48)], output=[i_brand#64, i_brand_id#63, sum#83])
         +- *(3) Project [ss_ext_sales_price#48, i_brand_id#63, i_brand#64]
            +- *(3) BroadcastHashJoin [ss_item_sk#35], [i_item_sk#56], Inner, BuildRight
               :- *(3) Project [ss_item_sk#35, ss_ext_sales_price#48]
               :  +- *(3) BroadcastHashJoin [d_date_sk#5], [ss_sold_date_sk#33], Inner, BuildLeft
               :     :- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
               :     :  +- *(1) Project [d_date_sk#5]
               :     :     +- *(1) Filter ((((isnotnull(d_moy#13) && isnotnull(d_year#11)) && (d_moy#13 = 11)) && (d_year#11 = 1999)) && isnotnull(d_date_sk#5))
               :     :        +- *(1) FileScan parquet tpcds.date_dim[d_date_sk#5,d_year#11,d_moy#13] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/d..., PartitionFilters: [], PushedFilters: [IsNotNull(d_moy), IsNotNull(d_year), EqualTo(d_moy,11), EqualTo(d_year,1999), IsNotNull(d_date_sk)], ReadSchema: struct<d_date_sk:int,d_year:int,d_moy:int>
               ...
               +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)))
                  +- *(2) Project [i_item_sk#56, i_brand_id#63, i_brand#64]
                     +- *(2) Filter ((isnotnull(i_manager_id#76) && (i_manager_id#76 = 28)) && isnotnull(i_item_sk#56))
                        +- *(2) FileScan parquet tpcds.item[i_item_sk#56,i_brand_id#63,i_brand#64,i_manager_id#76] Batched: true, Format: Parquet, Location: InMemoryFileIndex[file:/Users/angela/Desktop/spark-2.4.8-bin-hadoop2.7/spark-warehouse/tpcds.db/i..., PartitionFilters: [], PushedFilters: [IsNotNull(i_manager_id), EqualTo(i_manager_id,28), IsNotNull(i_item_sk)], ReadSchema: struct<i_item_sk:int,i_brand_id:int,i_brand:string,i_manager_id:int>
