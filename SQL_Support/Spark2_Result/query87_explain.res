...
+- Aggregate [c_last_name#63, c_first_name#62, d_date#28]
   +- Join LeftAnti, (((c_last_name#63 <=> c_last_name#259) && (c_first_name#62 <=> c_first_name#258)) && (d_date#28 <=> d_date#206))
      :- Aggregate [c_last_name#63, c_first_name#62, d_date#28], [c_last_name#63, c_first_name#62, d_date#28]
      :  +- Join LeftAnti, (((c_last_name#63 <=> c_last_name#195) && (c_first_name#62 <=> c_first_name#194)) && (d_date#28 <=> d_date#142))
      :     :- Aggregate [c_last_name#63, c_first_name#62, d_date#28], [c_last_name#63, c_first_name#62, d_date#28]
      :     :  +- Project [c_last_name#63, c_first_name#62, d_date#28]
      ...
      +- *(20) HashAggregate(keys=[c_last_name#63, c_first_name#62, d_date#28], functions=[], output=[])
         +- Exchange hashpartitioning(c_last_name#63, c_first_name#62, d_date#28, 200)
            +- *(19) HashAggregate(keys=[c_last_name#63, c_first_name#62, d_date#28], functions=[], output=[c_last_name#63, c_first_name#62, d_date#28])
               +- SortMergeJoin [coalesce(c_last_name#63, ), coalesce(c_first_name#62, ), coalesce(d_date#28, )], [coalesce(c_last_name#259, ), coalesce(c_first_name#258, ), coalesce(d_date#206, )], LeftAnti, (((c_last_name#63 <=> c_last_name#259) && (c_first_name#62 <=> c_first_name#258)) && (d_date#28 <=> d_date#206))
                  ...
                  :              +- SortMergeJoin [coalesce(c_last_name#63, ), coalesce(c_first_name#62, ), coalesce(d_date#28, )], [coalesce(c_last_name#195, ), coalesce(c_first_name#194, ), coalesce(d_date#142, )], LeftAnti, (((c_last_name#63 <=> c_last_name#195) && (c_first_name#62 <=> c_first_name#194)) && (d_date#28 <=> d_date#142))
...
Time taken: 4.235 seconds, Fetched 1 row(s)
Error in query: 
