...
Spark master: local[*], Application Id: local-1741580858269
== Parsed Logical Plan ==
...
Sort [c_last_name#101 ASC NULLS FIRST, c_first_name#100 ASC NULLS FIRST, c_salutation#99 ASC NULLS FIRST, c_preferred_cust_flag#102 DESC NULLS LAST, ss_ticket_number#16 ASC NULLS FIRST], true
+- Project [c_last_name#101, c_first_name#100, c_salutation#99, c_preferred_cust_flag#102, ss_ticket_number#16, cnt#0L]
   +- Filter ((ss_customer_sk#10 = c_customer_sk#92) AND ((cnt#0L >= cast(15 as bigint)) AND (cnt#0L <= cast(20 as bigint))))
      +- Join Inner
         :- SubqueryAlias dn
         :  +- Aggregate [ss_ticket_number#16, ss_customer_sk#10], [ss_ticket_number#16, ss_customer_sk#10, count(1) AS cnt#0L]
         :     +- Filter (((((ss_sold_date_sk#7 = d_date_sk#30) AND (ss_store_sk#14 = s_store_sk#58)) AND (ss_hdemo_sk#12 = hd_demo_sk#87)) AND ((((d_dom#39 >= 1) AND (d_dom#39 <= 3)) OR ((d_dom#39 >= 25) AND (d_dom#39 <= 28))) AND ((hd_buy_potential#89 = >10000) OR (hd_buy_potential#89 = Unknown)))) AND (((hd_vehicle_count#91 > 0) AND (CASE WHEN (hd_vehicle_count#91 > 0) THEN (cast(hd_dep_count#90 as double) / cast(hd_vehicle_count#91 as double)) ELSE cast(null as double) END > cast(1.2 as double))) AND (d_year#36 IN (1999,(1999 + 1),(1999 + 2)) AND s_county#81 IN (Williamson County,Williamson County,Williamson County,Williamson County,Williamson County,Williamson County,Williamson County,Williamson County))))
         :        +- Join Inner
         :           :- Join Inner
         :           :  :- Join Inner
...
+- Project [c_last_name#101, c_first_name#100, c_salutation#99, c_preferred_cust_flag#102, ss_ticket_number#16, cnt#0L]
   +- Join Inner, (ss_customer_sk#10 = c_customer_sk#92)
      ...
      :           :     :        +- Filter (((((d_dom#39 >= 1) AND (d_dom#39 <= 3)) OR ((d_dom#39 >= 25) AND (d_dom#39 <= 28))) AND d_year#36 IN (1999,2000,2001)) AND isnotnull(d_date_sk#30))
      :           :     :           +- Relation spark_catalog.tpcds.date_dim[d_date_sk#30,d_date_id#31,d_date#32,d_month_seq#33,d_week_seq#34,d_quarter_seq#35,d_year#36,d_dow#37,d_moy#38,d_dom#39,d_qoy#40,d_fy_year#41,d_fy_quarter_seq#42,d_fy_week_seq#43,d_day_name#44,d_quarter_name#45,d_holiday#46,d_weekend#47,d_following_holiday#48,d_first_dom#49,d_last_dom#50,d_same_day_ly#51,d_same_day_lq#52,d_current_day#53,... 4 more fields] parquet
      :           :     +- Project [s_store_sk#58]
      :           :        +- Filter ((isnotnull(s_county#81) AND (s_county#81 = Williamson County)) AND isnotnull(s_store_sk#58))
      :           :           +- Relation spark_catalog.tpcds.store[s_store_sk#58,s_store_id#59,s_rec_start_date#60,s_rec_end_date#61,s_closed_date_sk#62,s_store_name#63,s_number_employees#64,s_floor_space#65,s_hours#66,s_manager#67,s_market_id#68,s_geography_class#69,s_market_desc#70,s_market_manager#71,s_division_id#72,s_division_name#73,s_company_id#74,s_company_name#75,s_street_number#76,s_street_name#77,s_street_type#78,s_suite_number#79,s_city#80,s_county#81,... 5 more fields] parquet
      :           +- Project [hd_demo_sk#87]
      :              +- Filter ((isnotnull(hd_vehicle_count#91) AND ((((hd_buy_potential#89 = >10000) OR (hd_buy_potential#89 = Unknown)) AND (hd_vehicle_count#91 > 0)) AND CASE WHEN (hd_vehicle_count#91 > 0) THEN ((cast(hd_dep_count#90 as double) / cast(hd_vehicle_count#91 as double)) > 1.2) END)) AND isnotnull(hd_demo_sk#87))
      :                 +- Relation spark_catalog.tpcds.household_demographics[hd_demo_sk#87,hd_income_band_sk#88,hd_buy_potential#89,hd_dep_count#90,hd_vehicle_count#91] parquet
...
+- Sort [c_last_name#101 ASC NULLS FIRST, c_first_name#100 ASC NULLS FIRST, c_salutation#99 ASC NULLS FIRST, c_preferred_cust_flag#102 DESC NULLS LAST, ss_ticket_number#16 ASC NULLS FIRST], true, 0
   +- Exchange rangepartitioning(c_last_name#101 ASC NULLS FIRST, c_first_name#100 ASC NULLS FIRST, c_salutation#99 ASC NULLS FIRST, c_preferred_cust_flag#102 DESC NULLS LAST, ss_ticket_number#16 ASC NULLS FIRST, 200), ENSURE_REQUIREMENTS, [plan_id=126]
      +- Project [c_last_name#101, c_first_name#100, c_salutation#99, c_preferred_cust_flag#102, ss_ticket_number#16, cnt#0L]
         +- BroadcastHashJoin [ss_customer_sk#10], [c_customer_sk#92], Inner, BuildRight, false
            ...
            :                 :     :        +- Project [d_date_sk#30]
            :                 :     :           +- Filter (((((d_dom#39 >= 1) AND (d_dom#39 <= 3)) OR ((d_dom#39 >= 25) AND (d_dom#39 <= 28))) AND d_year#36 IN (1999,2000,2001)) AND isnotnull(d_date_sk#30))
            :                 :     :              +- FileScan parquet spark_catalog.tpcds.date_dim[d_date_sk#30,d_year#36,d_dom#39] Batched: true, DataFilters: [(((d_dom#39 >= 1) AND (d_dom#39 <= 3)) OR ((d_dom#39 >= 25) AND (d_dom#39 <= 28))), d_year#36 IN..., Format: Parquet, Location: InMemoryFileIndex(1 paths)[file:/Users/angela/Desktop/spark-3.5.5-bin-hadoop3/spark-warehouse/tpc..., PartitionFilters: [], PushedFilters: [Or(And(GreaterThanOrEqual(d_dom,1),LessThanOrEqual(d_dom,3)),And(GreaterThanOrEqual(d_dom,25),Le..., ReadSchema: struct<d_date_sk:int,d_year:int,d_dom:int>
            :                 :     +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=109]
            :                 :        +- Project [s_store_sk#58]
            :                 :           +- Filter ((isnotnull(s_county#81) AND (s_county#81 = Williamson County)) AND isnotnull(s_store_sk#58))
            :                 :              +- FileScan parquet spark_catalog.tpcds.store[s_store_sk#58,s_county#81] Batched: true, DataFilters: [isnotnull(s_county#81), (s_county#81 = Williamson County), isnotnull(s_store_sk#58)], Format: Parquet, Location: InMemoryFileIndex(1 paths)[file:/Users/angela/Desktop/spark-3.5.5-bin-hadoop3/spark-warehouse/tpc..., PartitionFilters: [], PushedFilters: [IsNotNull(s_county), EqualTo(s_county,Williamson County), IsNotNull(s_store_sk)], ReadSchema: struct<s_store_sk:int,s_county:string>
