...
Spark master: local[*], Application Id: local-1741581006496
== Parsed Logical Plan ==
'GlobalLimit 100
+- 'LocalLimit 100
...
Aggregate [count(1) AS count(1)#235L]
+- Project
   +- Join LeftSemi, (((c_last_name#66 <=> c_last_name#226) AND (c_first_name#65 <=> c_first_name#225)) AND (d_date#31 <=> d_date#191))
      :- Join LeftSemi, (((c_last_name#66 <=> c_last_name#180) AND (c_first_name#65 <=> c_first_name#179)) AND (d_date#31 <=> d_date#145))
...
+- HashAggregate(keys=[], functions=[count(1)], output=[count(1)#235L])
   +- Exchange SinglePartition, ENSURE_REQUIREMENTS, [plan_id=237]
      +- HashAggregate(keys=[], functions=[partial_count(1)], output=[count#246L])
         +- Project
            +- SortMergeJoin [coalesce(c_last_name#66, ), isnull(c_last_name#66), coalesce(c_first_name#65, ), isnull(c_first_name#65), coalesce(d_date#31, ), isnull(d_date#31)], [coalesce(c_last_name#226, ), isnull(c_last_name#226), coalesce(c_first_name#225, ), isnull(c_first_name#225), coalesce(d_date#191, ), isnull(d_date#191)], LeftSemi
               :- SortMergeJoin [coalesce(c_last_name#66, ), isnull(c_last_name#66), coalesce(c_first_name#65, ), isnull(c_first_name#65), coalesce(d_date#31, ), isnull(d_date#31)], [coalesce(c_last_name#180, ), isnull(c_last_name#180), coalesce(c_first_name#179, ), isnull(c_first_name#179), coalesce(d_date#145, ), isnull(d_date#145)], LeftSemi
...
Time taken: 2.866 seconds, Fetched 1 row(s)
