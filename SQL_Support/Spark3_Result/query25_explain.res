...
Spark master: local[*], Application Id: local-1741580501634
== Parsed Logical Plan ==
'GlobalLimit 100
+- 'LocalLimit 100
...
+- LocalLimit 100
   +- Sort [i_item_id#143 ASC NULLS FIRST, i_item_desc#146 ASC NULLS FIRST, s_store_id#114 ASC NULLS FIRST, s_store_name#118 ASC NULLS FIRST], true
      +- Aggregate [i_item_id#143, i_item_desc#146, s_store_id#114, s_store_name#118], [i_item_id#143, i_item_desc#146, s_store_id#114, s_store_name#118, sum(ss_net_profit#30) AS store_sales_profit#0, sum(sr_net_loss#50) AS store_returns_loss#1, sum(cs_net_profit#84) AS catalog_sales_profit#2]
         +- Filter (((((d_moy#93 = 4) AND (d_year#91 = 2001)) AND ((d_date_sk#85 = ss_sold_date_sk#8) AND (i_item_sk#142 = ss_item_sk#10))) AND (((s_store_sk#113 = ss_store_sk#15) AND (ss_customer_sk#11 = sr_customer_sk#34)) AND ((ss_item_sk#10 = sr_item_sk#33) AND (ss_ticket_number#17 = sr_ticket_number#40)))) AND ((((sr_returned_date_sk#31 = d_date_sk#164) AND ((d_moy#172 >= 4) AND (d_moy#172 <= 10))) AND ((d_year#170 = 2001) AND (sr_customer_sk#34 = cs_bill_customer_sk#54))) AND (((sr_item_sk#33 = cs_item_sk#66) AND (cs_sold_date_sk#51 = d_date_sk#192)) AND (((d_moy#200 >= 4) AND (d_moy#200 <= 10)) AND (d_year#198 = 2001)))))
            +- Join Inner
               :- Join Inner
               :  :- Join Inner
               :  :  :- Join Inner
...
+- LocalLimit 100
   +- Sort [i_item_id#143 ASC NULLS FIRST, i_item_desc#146 ASC NULLS FIRST, s_store_id#114 ASC NULLS FIRST, s_store_name#118 ASC NULLS FIRST], true
      +- Aggregate [i_item_id#143, i_item_desc#146, s_store_id#114, s_store_name#118], [i_item_id#143, i_item_desc#146, s_store_id#114, s_store_name#118, sum(ss_net_profit#30) AS store_sales_profit#0, sum(sr_net_loss#50) AS store_returns_loss#1, sum(cs_net_profit#84) AS catalog_sales_profit#2]
         +- Project [ss_net_profit#30, sr_net_loss#50, cs_net_profit#84, s_store_id#114, s_store_name#118, i_item_id#143, i_item_desc#146]
            +- Join Inner, (i_item_sk#142 = ss_item_sk#10)
               :- Project [ss_item_sk#10, ss_net_profit#30, sr_net_loss#50, cs_net_profit#84, s_store_id#114, s_store_name#118]
               :  +- Join Inner, (s_store_sk#113 = ss_store_sk#15)
               :     :- Project [ss_item_sk#10, ss_store_sk#15, ss_net_profit#30, sr_net_loss#50, cs_net_profit#84]
               :     :  +- Join Inner, (cs_sold_date_sk#51 = d_date_sk#192)
               :     :     :- Project [ss_item_sk#10, ss_store_sk#15, ss_net_profit#30, sr_net_loss#50, cs_sold_date_sk#51, cs_net_profit#84]
               :     :     :  +- Join Inner, (sr_returned_date_sk#31 = d_date_sk#164)
               :     :     :     :- Project [ss_item_sk#10, ss_store_sk#15, ss_net_profit#30, sr_returned_date_sk#31, sr_net_loss#50, cs_sold_date_sk#51, cs_net_profit#84]
               :     :     :     :  +- Join Inner, (d_date_sk#85 = ss_sold_date_sk#8)
               :     :     :     :     :- Project [ss_sold_date_sk#8, ss_item_sk#10, ss_store_sk#15, ss_net_profit#30, sr_returned_date_sk#31, sr_net_loss#50, cs_sold_date_sk#51, cs_net_profit#84]
               :     :     :     :     :  +- Join Inner, ((sr_customer_sk#34 = cs_bill_customer_sk#54) AND (sr_item_sk#33 = cs_item_sk#66))
               :     :     :     :     :     :- Project [ss_sold_date_sk#8, ss_item_sk#10, ss_store_sk#15, ss_net_profit#30, sr_returned_date_sk#31, sr_item_sk#33, sr_customer_sk#34, sr_net_loss#50]
               ...
               :     :     :     :     :     :     :- Project [ss_sold_date_sk#8, ss_item_sk#10, ss_customer_sk#11, ss_store_sk#15, ss_ticket_number#17, ss_net_profit#30]
               ...
               :     :     :     :     :     :     :     +- Relation spark_catalog.tpcds.store_sales[ss_sold_date_sk#8,ss_sold_time_sk#9,ss_item_sk#10,ss_customer_sk#11,ss_cdemo_sk#12,ss_hdemo_sk#13,ss_addr_sk#14,ss_store_sk#15,ss_promo_sk#16,ss_ticket_number#17,ss_quantity#18,ss_wholesale_cost#19,ss_list_price#20,ss_sales_price#21,ss_ext_discount_amt#22,ss_ext_sales_price#23,ss_ext_wholesale_cost#24,ss_ext_list_price#25,ss_ext_tax#26,ss_coupon_amt#27,ss_net_paid#28,ss_net_paid_inc_tax#29,ss_net_profit#30] parquet
               :     :     :     :     :     :     +- Project [sr_returned_date_sk#31, sr_item_sk#33, sr_customer_sk#34, sr_ticket_number#40, sr_net_loss#50]
               ...
               :     :     :     :     :     :           +- Relation spark_catalog.tpcds.store_returns[sr_returned_date_sk#31,sr_return_time_sk#32,sr_item_sk#33,sr_customer_sk#34,sr_cdemo_sk#35,sr_hdemo_sk#36,sr_addr_sk#37,sr_store_sk#38,sr_reason_sk#39,sr_ticket_number#40,sr_return_quantity#41,sr_return_amt#42,sr_return_tax#43,sr_return_amt_inc_tax#44,sr_fee#45,sr_return_ship_cost#46,sr_refunded_cash#47,sr_reversed_charge#48,sr_store_credit#49,sr_net_loss#50] parquet
               :     :     :     :     :     +- Project [cs_sold_date_sk#51, cs_bill_customer_sk#54, cs_item_sk#66, cs_net_profit#84]
               :     :     :     :     :        +- Filter ((isnotnull(cs_bill_customer_sk#54) AND isnotnull(cs_item_sk#66)) AND isnotnull(cs_sold_date_sk#51))
               :     :     :     :     :           +- Relation spark_catalog.tpcds.catalog_sales[cs_sold_date_sk#51,cs_sold_time_sk#52,cs_ship_date_sk#53,cs_bill_customer_sk#54,cs_bill_cdemo_sk#55,cs_bill_hdemo_sk#56,cs_bill_addr_sk#57,cs_ship_customer_sk#58,cs_ship_cdemo_sk#59,cs_ship_hdemo_sk#60,cs_ship_addr_sk#61,cs_call_center_sk#62,cs_catalog_page_sk#63,cs_ship_mode_sk#64,cs_warehouse_sk#65,cs_item_sk#66,cs_promo_sk#67,cs_order_number#68,cs_quantity#69,cs_wholesale_cost#70,cs_list_price#71,cs_sales_price#72,cs_ext_discount_amt#73,cs_ext_sales_price#74,... 10 more fields] parquet
               :     :     :     :     +- Project [d_date_sk#85]
               :     :     :     :        +- Filter (((isnotnull(d_moy#93) AND isnotnull(d_year#91)) AND ((d_moy#93 = 4) AND (d_year#91 = 2001))) AND isnotnull(d_date_sk#85))
               :     :     :     :           +- Relation spark_catalog.tpcds.date_dim[d_date_sk#85,d_date_id#86,d_date#87,d_month_seq#88,d_week_seq#89,d_quarter_seq#90,d_year#91,d_dow#92,d_moy#93,d_dom#94,d_qoy#95,d_fy_year#96,d_fy_quarter_seq#97,d_fy_week_seq#98,d_day_name#99,d_quarter_name#100,d_holiday#101,d_weekend#102,d_following_holiday#103,d_first_dom#104,d_last_dom#105,d_same_day_ly#106,d_same_day_lq#107,d_current_day#108,... 4 more fields] parquet
               :     :     :     +- Project [d_date_sk#164]
               :     :     :        +- Filter (((isnotnull(d_moy#172) AND isnotnull(d_year#170)) AND (((d_moy#172 >= 4) AND (d_moy#172 <= 10)) AND (d_year#170 = 2001))) AND isnotnull(d_date_sk#164))
               :     :     :           +- Relation spark_catalog.tpcds.date_dim[d_date_sk#164,d_date_id#165,d_date#166,d_month_seq#167,d_week_seq#168,d_quarter_seq#169,d_year#170,d_dow#171,d_moy#172,d_dom#173,d_qoy#174,d_fy_year#175,d_fy_quarter_seq#176,d_fy_week_seq#177,d_day_name#178,d_quarter_name#179,d_holiday#180,d_weekend#181,d_following_holiday#182,d_first_dom#183,d_last_dom#184,d_same_day_ly#185,d_same_day_lq#186,d_current_day#187,... 4 more fields] parquet
               :     :     +- Project [d_date_sk#192]
               :     :        +- Filter (((isnotnull(d_moy#200) AND isnotnull(d_year#198)) AND (((d_moy#200 >= 4) AND (d_moy#200 <= 10)) AND (d_year#198 = 2001))) AND isnotnull(d_date_sk#192))
               :     :           +- Relation spark_catalog.tpcds.date_dim[d_date_sk#192,d_date_id#193,d_date#194,d_month_seq#195,d_week_seq#196,d_quarter_seq#197,d_year#198,d_dow#199,d_moy#200,d_dom#201,d_qoy#202,d_fy_year#203,d_fy_quarter_seq#204,d_fy_week_seq#205,d_day_name#206,d_quarter_name#207,d_holiday#208,d_weekend#209,d_following_holiday#210,d_first_dom#211,d_last_dom#212,d_same_day_ly#213,d_same_day_lq#214,d_current_day#215,... 4 more fields] parquet
...
+- TakeOrderedAndProject(limit=100, orderBy=[i_item_id#143 ASC NULLS FIRST,i_item_desc#146 ASC NULLS FIRST,s_store_id#114 ASC NULLS FIRST,s_store_name#118 ASC NULLS FIRST], output=[i_item_id#143,i_item_desc#146,s_store_id#114,s_store_name#118,store_sales_profit#0,store_returns_loss#1,catalog_sales_profit#2])
   +- HashAggregate(keys=[i_item_id#143, i_item_desc#146, s_store_id#114, s_store_name#118], functions=[sum(ss_net_profit#30), sum(sr_net_loss#50), sum(cs_net_profit#84)], output=[i_item_id#143, i_item_desc#146, s_store_id#114, s_store_name#118, store_sales_profit#0, store_returns_loss#1, catalog_sales_profit#2])
      +- Exchange hashpartitioning(i_item_id#143, i_item_desc#146, s_store_id#114, s_store_name#118, 200), ENSURE_REQUIREMENTS, [plan_id=186]
         +- HashAggregate(keys=[i_item_id#143, i_item_desc#146, s_store_id#114, s_store_name#118], functions=[partial_sum(ss_net_profit#30), partial_sum(sr_net_loss#50), partial_sum(cs_net_profit#84)], output=[i_item_id#143, i_item_desc#146, s_store_id#114, s_store_name#118, sum#234, sum#235, sum#236])
            +- Project [ss_net_profit#30, sr_net_loss#50, cs_net_profit#84, s_store_id#114, s_store_name#118, i_item_id#143, i_item_desc#146]
               +- BroadcastHashJoin [ss_item_sk#10], [i_item_sk#142], Inner, BuildRight, false
                  ...
                  :     :     :     :     :     :              +- Filter (((isnotnull(sr_customer_sk#34) AND isnotnull(sr_item_sk#33)) AND isnotnull(sr_ticket_number#40)) AND isnotnull(sr_returned_date_sk#31))
                  :     :     :     :     :     :                 +- FileScan parquet spark_catalog.tpcds.store_returns[sr_returned_date_sk#31,sr_item_sk#33,sr_customer_sk#34,sr_ticket_number#40,sr_net_loss#50] Batched: true, DataFilters: [isnotnull(sr_customer_sk#34), isnotnull(sr_item_sk#33), isnotnull(sr_ticket_number#40), isnotnul..., Format: Parquet, Location: InMemoryFileIndex(1 paths)[file:/Users/angela/Desktop/spark-3.5.5-bin-hadoop3/spark-warehouse/tpc..., PartitionFilters: [], PushedFilters: [IsNotNull(sr_customer_sk), IsNotNull(sr_item_sk), IsNotNull(sr_ticket_number), IsNotNull(sr_retu..., ReadSchema: struct<sr_returned_date_sk:int,sr_item_sk:int,sr_customer_sk:int,sr_ticket_number:int,sr_net_loss...
                  ...
                  :     :     :     :     :           +- Filter ((isnotnull(cs_bill_customer_sk#54) AND isnotnull(cs_item_sk#66)) AND isnotnull(cs_sold_date_sk#51))
                  :     :     :     :     :              +- FileScan parquet spark_catalog.tpcds.catalog_sales[cs_sold_date_sk#51,cs_bill_customer_sk#54,cs_item_sk#66,cs_net_profit#84] Batched: true, DataFilters: [isnotnull(cs_bill_customer_sk#54), isnotnull(cs_item_sk#66), isnotnull(cs_sold_date_sk#51)], Format: Parquet, Location: InMemoryFileIndex(1 paths)[file:/Users/angela/Desktop/spark-3.5.5-bin-hadoop3/spark-warehouse/tpc..., PartitionFilters: [], PushedFilters: [IsNotNull(cs_bill_customer_sk), IsNotNull(cs_item_sk), IsNotNull(cs_sold_date_sk)], ReadSchema: struct<cs_sold_date_sk:int,cs_bill_customer_sk:int,cs_item_sk:int,cs_net_profit:double>
                  :     :     :     :     +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=165]
                  :     :     :     :        +- Project [d_date_sk#85]
                  :     :     :     :           +- Filter ((((isnotnull(d_moy#93) AND isnotnull(d_year#91)) AND (d_moy#93 = 4)) AND (d_year#91 = 2001)) AND isnotnull(d_date_sk#85))
                  :     :     :     :              +- FileScan parquet spark_catalog.tpcds.date_dim[d_date_sk#85,d_year#91,d_moy#93] Batched: true, DataFilters: [isnotnull(d_moy#93), isnotnull(d_year#91), (d_moy#93 = 4), (d_year#91 = 2001), isnotnull(d_date_..., Format: Parquet, Location: InMemoryFileIndex(1 paths)[file:/Users/angela/Desktop/spark-3.5.5-bin-hadoop3/spark-warehouse/tpc..., PartitionFilters: [], PushedFilters: [IsNotNull(d_moy), IsNotNull(d_year), EqualTo(d_moy,4), EqualTo(d_year,2001), IsNotNull(d_date_sk)], ReadSchema: struct<d_date_sk:int,d_year:int,d_moy:int>
                  :     :     :     +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=169]
                  :     :     :        +- Project [d_date_sk#164]
                  :     :     :           +- Filter (((((isnotnull(d_moy#172) AND isnotnull(d_year#170)) AND (d_moy#172 >= 4)) AND (d_moy#172 <= 10)) AND (d_year#170 = 2001)) AND isnotnull(d_date_sk#164))
                  :     :     :              +- FileScan parquet spark_catalog.tpcds.date_dim[d_date_sk#164,d_year#170,d_moy#172] Batched: true, DataFilters: [isnotnull(d_moy#172), isnotnull(d_year#170), (d_moy#172 >= 4), (d_moy#172 <= 10), (d_year#170 = ..., Format: Parquet, Location: InMemoryFileIndex(1 paths)[file:/Users/angela/Desktop/spark-3.5.5-bin-hadoop3/spark-warehouse/tpc..., PartitionFilters: [], PushedFilters: [IsNotNull(d_moy), IsNotNull(d_year), GreaterThanOrEqual(d_moy,4), LessThanOrEqual(d_moy,10), Equ..., ReadSchema: struct<d_date_sk:int,d_year:int,d_moy:int>
                  :     :     +- BroadcastExchange HashedRelationBroadcastMode(List(cast(input[0, int, true] as bigint)),false), [plan_id=173]
                  :     :        +- Project [d_date_sk#192]
                  :     :           +- Filter (((((isnotnull(d_moy#200) AND isnotnull(d_year#198)) AND (d_moy#200 >= 4)) AND (d_moy#200 <= 10)) AND (d_year#198 = 2001)) AND isnotnull(d_date_sk#192))
                  :     :              +- FileScan parquet spark_catalog.tpcds.date_dim[d_date_sk#192,d_year#198,d_moy#200] Batched: true, DataFilters: [isnotnull(d_moy#200), isnotnull(d_year#198), (d_moy#200 >= 4), (d_moy#200 <= 10), (d_year#198 = ..., Format: Parquet, Location: InMemoryFileIndex(1 paths)[file:/Users/angela/Desktop/spark-3.5.5-bin-hadoop3/spark-warehouse/tpc..., PartitionFilters: [], PushedFilters: [IsNotNull(d_moy), IsNotNull(d_year), GreaterThanOrEqual(d_moy,4), LessThanOrEqual(d_moy,10), Equ..., ReadSchema: struct<d_date_sk:int,d_year:int,d_moy:int>
...
Time taken: 3.04 seconds, Fetched 1 row(s)
